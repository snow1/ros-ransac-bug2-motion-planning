...
# Laser scan callback, implements RANSAC algorithm and passes wall yaw angle to bug2
...
def init():
    # For rviz, visualizes ransac lines
    ...
    rospy.Subscriber('/scan', LaserScan, laser_data, (marker_pub, line_marker, point_marker, wall_angle_pub, obstacle_pub))
